<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserList.aspx.cs" Inherits="FinalProject.SystemAdmin.User.UserList" %>
    ...
    <form id="form1" runat="server">
        ...
        <div id="divHeader" style="width: 100%; height: 30%; display: flex; flex-flow: row; align-items: center; justify-content: center; text-align: center">
            ...
            <div id="divList" style="width: 20%; float: right; text-align: right; display: flex; flex-flow: row;">
                <asp:PlaceHolder runat="server" ID="phSalesManu" Visible="false">
                    ...
                    <div style="width: 30%; text-align: center;">
                        <a href="/SystemAdmin/User/UserInfo.aspx" target="_self" style="text-decoration: none;">帳號管理</a>
                    </div>
                    <div style="width: 30%; text-align: center;">
                ...
                <asp:PlaceHolder runat="server" ID="phWarehouseManu" Visible="false">
                    ...
                    <div style="width: 25%; text-align: center;">
                        <a href="/SystemAdmin/Warehouse/ItemList.aspx" target="_self" style="text-decoration: none;">品項管理</a>
                    </div>
                    <div style="width: 25%; text-align: center;">
                        <a href="/SystemAdmin/User/UserInfo.aspx" target="_self" style="text-decoration: none;">帳號管理</a>
                    </div>
                    <div style="width: 25%; text-align: center;">
                        <asp:Button runat="server" ID="Button1" Text="登出" OnClick="btnLogout_Click" Style="border: none; background: none; color: #0000ff; margin: 0; padding: 0; font-size: 1rem;" />
                    </div>
                </asp:PlaceHolder>
            </div>
        </div>
        ...
        <div id="divMiddle" style="width: 100%; height: 70%; display: flex; flex-flow: row; align-items: center; justify-content: center; text-align: center;">
            <div id="divMiddleLeft" style="width: 10%; height: 100%; display: flex; flex-flow: column; align-items: center; justify-content: center; text-align: center;">
                <a href="/SystemAdmin/User/UserList.aspx" target="_self" style="text-decoration: none; position: absolute; top: 12rem; left: 3rem;">中央廚房員工通訊錄</a>
                <a href="/SystemAdmin/User/ChainsUserList.aspx" target="_self" style="text-decoration: none; position: absolute; top: 16rem; left: 3rem;">分店員工通訊錄</a>
                <asp:PlaceHolder runat="server" ID="phManager" Visible="false">
                    <a href="/SystemAdmin/User/UserDetail.aspx" target="_self" style="text-decoration: none; position: absolute; top: 20rem; left: 3rem;">新增部門員工</a>
                </asp:PlaceHolder>
            </div>
            <div id="divMiddleContent" style="width: 70%; display: flex; flex-flow: column; align-items: center; text-align: left; justify-content: center; float: right;">
                <h2>中央廚房員工通訊錄</h2>
                <asp:GridView ID="gvDepartEmployeeList" runat="server" AutoGenerateColumns="False" OnRowDataBound="gvDepartEmployeeList_RowDataBound" Style="margin-top: 1rem" CellPadding="10" ForeColor="#333333" GridLines="Both">
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField>
                            <ItemTemplate>
                                <a href="/SystemAdmin/User/UserDetail.aspx?EID=<%# Eval("EmployeeID") %>">詳細資訊</a>
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
                ...
                <div style="margin-top: 1rem;">
                    <uc1:ucPager runat="server" ID="ucPager" PageSize="10" CurrentPage="1" TotalSize="10" Url="/SystemAdmin/User/UserList.aspx" />
