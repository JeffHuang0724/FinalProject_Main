<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Order.aspx.cs" Inherits="FinalProject.SystemAdmin.Warehouse.order" %>
    ...
    <form id="form1" runat="server">
        ...
        <div id="divHeader" style="width: 100%; height: 30%; display: flex; flex-flow: row; align-items: center; justify-content: center; text-align: center">
            ...
            <div id="divList" style="width: 20%; float: right; text-align: right; display: flex; flex-flow: row;">
                ...
                <div style="width: 25%; text-align: center;">
                    <a href="/SystemAdmin/Warehouse/ItemList.aspx" target="_blank" style="text-decoration: none;">品項管理</a>
                </div>
                <div style="width: 25%; text-align: center;">
        ...
        <div id="divMiddle" style="width: 100%; height: 70%; display: flex; flex-flow: row; align-items: center; justify-content: center; text-align: center;">
            <div id="divMiddleLeft" style="width: 10%; height: 100%; display: flex; flex-flow: column; align-items: center; justify-content: center; text-align: center;">
                <a href="/SystemAdmin/Warehouse/Order.aspx" target="_self" style="text-decoration: none; position: absolute; top: 12rem; left: 3rem;">處理訂單</a>
                <a href="/SystemAdmin/Warehouse/HistoryOrder.aspx" target="_self" style="text-decoration: none; position: absolute; top: 16rem; left: 3rem;">歷史訂單</a>
            </div>
            <div id="divMiddleContent" style="width: 70%; display: flex; flex-flow: column; align-items: center; text-align: center; justify-content: center; float: right;">
                <h2>倉儲訂單列表</h2>
                <asp:GridView ID="gvWarehouseOrderList" runat="server" AutoGenerateColumns="False" OnRowDataBound="gvWarehouseOrderList_RowDataBound" Style="margin-top: 1rem" CellPadding="10" ForeColor="#333333" GridLines="Both">
                    <Columns>
                        <asp:BoundField DataField="WNo" HeaderText="倉儲單號" />
                        <asp:BoundField DataField="OrderNo" HeaderText="客戶訂單編號" />
                        <asp:BoundField DataField="SNo" HeaderText="銷售單號" />
                        <asp:TemplateField HeaderText="客戶下單日期">
                            <ItemTemplate>
                        ...
                        <asp:TemplateField>
                            <ItemTemplate>
                                <a href="/SystemAdmin/Warehouse/OrderDetail.aspx?WNo=<%# Eval("WNo") %>">詳細訂單</a>
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
                ...
                <div style="margin-top: 1rem;">
                    <uc1:ucPager runat="server" ID="ucPager" PageSize="10" CurrentPage="1" TotalSize="10" Url="/SystemAdmin/Warehouse/Order.aspx" />
