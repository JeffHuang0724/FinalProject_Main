<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HistoryOrder.aspx.cs" Inherits="FinalProject.SystemAdmin.Sales.HistoryOrder" %>
    ...
    <form id="form1" runat="server">
        ...
        <div id="divMiddle" style="width: 100%; height: 70%; display: flex; flex-flow: row; align-items: center; justify-content: center; text-align: center;">
            ...
            <div id="divMiddleContent" style="width: 70%; display: flex; flex-flow: column; align-items: center; text-align: center; justify-content: center; float: right;">
                <h2>歷史銷售訂單列表</h2>
                <asp:GridView ID="gvSalesHistoryOrderList" runat="server" AutoGenerateColumns="False" Style="margin-top: 1rem" CellPadding="10" ForeColor="#333333" GridLines="Both">
                    <AlternatingRowStyle BackColor="White" />
                    <Columns>
                        <asp:BoundField DataField="SNo" HeaderText="銷售單號" />
                        <asp:BoundField DataField="OrderNo" HeaderText="訂單編號" />
                        <asp:BoundField HeaderText="分店下單日期" DataField="OrderDate" DataFormatString="{0:yyyy-MM-dd}" />
                ...
                <div style="margin-top: 1rem;">
                    <uc1:ucPager runat="server" ID="ucPager" PageSize="10" CurrentPage="1" TotalSize="10" Url="/SystemAdmin/Sales/HistoryOrder.aspx" />
