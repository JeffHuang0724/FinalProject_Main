...
{
    /// <summary>
    /// SearchOrderList 的摘要描述
    /// </summary>
    public class SearchOrderList : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            {
                string employeeID = drActInfo["EmployeeID"].ToString();
                DataTable dtOrderList = CustomerOrderManager.GetOrderList(employeeID);
                string jsonTxt = Newtonsoft.Json.JsonConvert.SerializeObject(dtOrderList);
                context.Response.ContentType = "application/json";
